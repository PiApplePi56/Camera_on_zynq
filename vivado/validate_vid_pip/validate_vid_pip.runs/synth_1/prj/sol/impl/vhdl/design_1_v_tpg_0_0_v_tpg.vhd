...
architecture behav of design_1_v_tpg_0_0_v_tpg is 
    ...
    "design_1_v_tpg_0_0_v_tpg,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=6.562000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.224321,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=13,HLS_SYN_DSP=0,HLS_SYN_FF=6610,HLS_SYN_LUT=7204,HLS_VERSION=2023_1}";
    ...
    signal icmp_ln455_fu_519_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln455_reg_586 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TKEEP : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_313_fid : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_313_ap_start : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TREADY : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_313_fid_ap_vld : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_313_ap_done : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_313_ap_ready : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_313_ap_idle : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_313_ap_continue : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_513_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal count_new_0_reg_302 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal icmp_ln458_fu_535_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_313_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal ap_sync_grp_v_tpgHlsDataFlow_fu_313_ap_ready : STD_LOGIC;
    signal ap_sync_grp_v_tpgHlsDataFlow_fu_313_ap_done : STD_LOGIC;
    signal ap_block_state5_on_subcall_done : BOOLEAN;
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_ready : STD_LOGIC := '0';
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_done : STD_LOGIC := '0';
    signal select_ln460_fu_566_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_544_p4 : STD_LOGIC_VECTOR (28 downto 0);
    signal icmp_ln460_fu_554_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln462_fu_560_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    grp_v_tpgHlsDataFlow_fu_313 : component design_1_v_tpg_0_0_v_tpgHlsDataFlow
    port map (
        height => height,
        width => width,
        field_id => field_id,
        ...
        dpYUVCoef => dpYUVCoef,
        m_axis_video_TDATA => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TDATA,
        m_axis_video_TKEEP => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TKEEP,
        m_axis_video_TSTRB => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TSTRB,
        m_axis_video_TUSER => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TUSER,
        m_axis_video_TLAST => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TLAST,
        m_axis_video_TID => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TID,
        m_axis_video_TDEST => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TDEST,
        fid => grp_v_tpgHlsDataFlow_fu_313_fid,
        s => s,
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ...
        ap_start => grp_v_tpgHlsDataFlow_fu_313_ap_start,
        ovrlayId_ap_vld => ap_const_logic_1,
        maskId_ap_vld => ap_const_logic_1,
        crossHairX_ap_vld => ap_const_logic_1,
        crossHairY_ap_vld => ap_const_logic_1,
        boxSize_ap_vld => ap_const_logic_1,
        boxColorR_ap_vld => ap_const_logic_1,
        boxColorG_ap_vld => ap_const_logic_1,
        boxColorB_ap_vld => ap_const_logic_1,
        m_axis_video_TVALID => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID,
        m_axis_video_TREADY => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TREADY,
        fid_in_ap_vld => ap_const_logic_1,
        fid_ap_vld => grp_v_tpgHlsDataFlow_fu_313_fid_ap_vld,
        field_id_ap_vld => ap_const_logic_1,
        ap_done => grp_v_tpgHlsDataFlow_fu_313_ap_done,
        ap_ready => grp_v_tpgHlsDataFlow_fu_313_ap_ready,
        ap_idle => grp_v_tpgHlsDataFlow_fu_313_ap_idle,
        ap_continue => grp_v_tpgHlsDataFlow_fu_313_ap_continue);

    grp_reg_unsigned_short_s_fu_513 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        d => bck_motion_en,
        ap_return => grp_reg_unsigned_short_s_fu_513_ap_return);
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TDATA,
        vld_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TKEEP,
        vld_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TSTRB,
        vld_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TUSER,
        vld_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TLAST,
        vld_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TID,
        vld_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TDEST,
        vld_in => grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID,
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_done <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state5_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_done <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_313_ap_done = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_done <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_ready <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state5_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_ready <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_313_ap_ready = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_ready <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    grp_v_tpgHlsDataFlow_fu_313_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_v_tpgHlsDataFlow_fu_313_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state4) or ((ap_sync_grp_v_tpgHlsDataFlow_fu_313_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state5)))) then 
                    grp_v_tpgHlsDataFlow_fu_313_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_v_tpgHlsDataFlow_fu_313_ap_ready = ap_const_logic_1)) then 
                    grp_v_tpgHlsDataFlow_fu_313_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
    ...
    count_new_0_reg_302_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                if ((icmp_ln458_fu_535_p2 = ap_const_lv1_0)) then 
                    count_new_0_reg_302 <= add_ln457_reg_590;
                elsif ((icmp_ln458_fu_535_p2 = ap_const_lv1_1)) then 
                    count_new_0_reg_302 <= ap_const_lv32_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln455_fu_519_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                add_ln457_reg_590 <= add_ln457_fu_529_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln455_reg_586 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                count <= count_new_0_reg_302;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                icmp_ln455_reg_586 <= icmp_ln455_fu_519_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln458_fu_535_p2 = ap_const_lv1_1))) then
                s <= select_ln460_fu_566_p3;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, icmp_ln455_fu_519_p2, ap_CS_fsm_state2, ap_CS_fsm_state5, ap_block_state5_on_subcall_done, ap_CS_fsm_state6, regslice_both_m_axis_video_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln455_fu_519_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    add_ln457_fu_529_p2 <= std_logic_vector(unsigned(count) + unsigned(ap_const_lv32_1));
    add_ln462_fu_560_p2 <= std_logic_vector(unsigned(s) + unsigned(ap_const_lv32_1));
    ...
    ap_block_state5_on_subcall_done_assign_proc : process(ap_sync_grp_v_tpgHlsDataFlow_fu_313_ap_ready, ap_sync_grp_v_tpgHlsDataFlow_fu_313_ap_done)
    begin
                ap_block_state5_on_subcall_done <= ((ap_sync_grp_v_tpgHlsDataFlow_fu_313_ap_ready and ap_sync_grp_v_tpgHlsDataFlow_fu_313_ap_done) = ap_const_logic_0);
    end process;
    ...
    ap_sync_grp_v_tpgHlsDataFlow_fu_313_ap_done <= (grp_v_tpgHlsDataFlow_fu_313_ap_done or ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_done);
    ap_sync_grp_v_tpgHlsDataFlow_fu_313_ap_ready <= (grp_v_tpgHlsDataFlow_fu_313_ap_ready or ap_sync_reg_grp_v_tpgHlsDataFlow_fu_313_ap_ready);
    fid <= grp_v_tpgHlsDataFlow_fu_313_fid;

    grp_v_tpgHlsDataFlow_fu_313_ap_continue_assign_proc : process(ap_CS_fsm_state5, ap_block_state5_on_subcall_done)
    begin
        if (((ap_const_boolean_0 = ap_block_state5_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
            grp_v_tpgHlsDataFlow_fu_313_ap_continue <= ap_const_logic_1;
        else 
            grp_v_tpgHlsDataFlow_fu_313_ap_continue <= ap_const_logic_0;
        end if; 
    end process;

    grp_v_tpgHlsDataFlow_fu_313_ap_start <= grp_v_tpgHlsDataFlow_fu_313_ap_start_reg;
    grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TREADY <= (m_axis_video_TREADY_int_regslice and ap_CS_fsm_state5);
    icmp_ln455_fu_519_p2 <= "1" when (grp_reg_unsigned_short_s_fu_513_ap_return = ap_const_lv16_1) else "0";
    icmp_ln458_fu_535_p2 <= "1" when (add_ln457_reg_590 = ap_const_lv32_A) else "0";
    icmp_ln460_fu_554_p2 <= "1" when (signed(tmp_1_fu_544_p4) < signed(ap_const_lv29_1)) else "0";
    m_axis_video_TVALID <= regslice_both_m_axis_video_V_data_V_U_vld_out;
    m_axis_video_TVALID_int_regslice <= grp_v_tpgHlsDataFlow_fu_313_m_axis_video_TVALID;
    select_ln460_fu_566_p3 <= 
        add_ln462_fu_560_p2 when (icmp_ln460_fu_554_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_1_fu_544_p4 <= s(31 downto 3);
end behav;
