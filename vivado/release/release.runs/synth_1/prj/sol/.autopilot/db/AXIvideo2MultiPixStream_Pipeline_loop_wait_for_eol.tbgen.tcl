...
set C_modelArgList {
	{ axi_data_2_lcssa int 30 regular  }
	...
	{ axi_data_4_out int 30 regular {pointer 1}  }
	{ axi_last_4_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "axi_data_2_lcssa", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_4_out", "interface" : "wire", "bitwidth" : 30, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ axi_data_2_lcssa sc_in sc_lv 30 signal 0 } 
	{ axi_last_2_lcssa sc_in sc_lv 1 signal 1 } 
	{ eol_0_lcssa sc_in sc_lv 1 signal 2 } 
	{ s_axis_video_TDATA sc_in sc_lv 32 signal 3 } 
	{ s_axis_video_TREADY sc_out sc_logic 1 inacc 9 } 
	{ s_axis_video_TKEEP sc_in sc_lv 4 signal 4 } 
	{ s_axis_video_TSTRB sc_in sc_lv 4 signal 5 } 
	...
	{ axi_data_4_out sc_out sc_lv 30 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_2_lcssa", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "axi_data_2_lcssa", "role": "default" }} , 
 	...
 	{ "name": "axi_data_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "axi_data_4_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	axi_data_2_lcssa { ap_none {  { axi_data_2_lcssa in_data 0 30 } } }
	...
	axi_data_4_out { ap_vld {  { axi_data_4_out out_data 1 30 }  { axi_data_4_out_ap_vld out_vld 1 1 } } }
