...
wire   [11:0] trunc_ln782_fu_267_p1;
reg   [11:0] trunc_ln782_reg_369;
wire    ap_CS_fsm_state2;
wire   [12:0] empty_fu_271_p1;
reg   [12:0] empty_reg_374;
wire   [0:0] icmp_ln789_fu_275_p2;
reg   [0:0] icmp_ln789_reg_380;
wire   [0:0] cmp10294_fu_294_p2;
reg   [0:0] cmp10294_reg_408;
wire    ap_CS_fsm_state4;
wire   [0:0] cond_fu_299_p2;
reg   [0:0] cond_reg_412;
wire   [0:0] icmp_ln800_fu_308_p2;
reg   [0:0] icmp_ln800_reg_417;
wire    ap_CS_fsm_state5;
wire   [11:0] i_4_fu_313_p2;
reg   [11:0] i_4_reg_421;
...
wire   [23:0] grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_data_out;
wire    grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_data_out_ap_vld;
wire   [0:0] grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_last_out;
wire    grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_last_out_ap_vld;
...
wire   [23:0] grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_201_axi_data_7_out;
wire    grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_201_axi_data_7_out_ap_vld;
...
wire   [0:0] grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_229_axi_last_4_out;
wire    grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_229_axi_last_4_out_ap_vld;
...
design_1_v_tpg_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181(
    ...
    .axi_data_out(grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_data_out),
    .axi_data_out_ap_vld(grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_data_out_ap_vld),
    .axi_last_out(grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_last_out),
    .axi_last_out_ap_vld(grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_last_out_ap_vld)
);
...
design_1_v_tpg_0_0_AXIvideo2MultiPixStream_Pipeline_loop_width grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_201(
    ...
    .axi_data_7_out(grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_201_axi_data_7_out),
    .axi_data_7_out_ap_vld(grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_201_axi_data_7_out_ap_vld)
);
...
design_1_v_tpg_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_229(
    ...
    .axi_last_4_out(grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_229_axi_last_4_out),
    .axi_last_4_out_ap_vld(grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_229_axi_last_4_out_ap_vld)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state6) & ((icmp_ln800_reg_417 == 1'd1) | (icmp_ln789_reg_380 == 1'd1)))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln800_reg_417 == 1'd0) & (cmp10294_reg_408 == 1'd0) & (icmp_ln789_reg_380 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln800_reg_417 == 1'd0) & (cmp10294_reg_408 == 1'd1) & (icmp_ln789_reg_380 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
        axi_data_2_lcssa_reg_148 <= axi_data_6_fu_106;
    end else if (((cmp10294_reg_408 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
        axi_data_2_lcssa_reg_148 <= grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_201_axi_data_7_out;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state10) & (grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_229_axi_data_4_out_ap_vld == 1'b1))) begin
        axi_data_6_fu_106 <= grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_229_axi_data_4_out;
    end else if (((grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_data_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        axi_data_6_fu_106 <= grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_data_out;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln800_reg_417 == 1'd0) & (cmp10294_reg_408 == 1'd1) & (icmp_ln789_reg_380 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
        axi_last_2_lcssa_reg_158 <= axi_last_2_reg_138;
    end else if (((cmp10294_reg_408 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        axi_last_2_reg_138 <= axi_last_4_loc_fu_86;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        axi_last_2_reg_138 <= grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_181_axi_last_out;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state10) & (grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_229_axi_last_4_out_ap_vld == 1'b1))) begin
        axi_last_4_loc_fu_86 <= grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_229_axi_last_4_out;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        cmp10294_reg_408 <= cmp10294_fu_294_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        i_4_reg_421 <= i_4_fu_313_p2;
        icmp_ln800_reg_417 <= icmp_ln800_fu_308_p2;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) & ((icmp_ln800_reg_417 == 1'd1) | (icmp_ln789_reg_380 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & ((icmp_ln800_reg_417 == 1'd1) | (icmp_ln789_reg_380 == 1'd1)))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((icmp_ln800_reg_417 == 1'd0) & (cmp10294_reg_408 == 1'd1) & (icmp_ln789_reg_380 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
        ...
        ap_ST_fsm_state7 : begin
            if (((1'b1 == ap_CS_fsm_state7) & (grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_201_ap_done == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state7;
            end
...
assign cmp10294_fu_294_p2 = ((empty_reg_374 == 13'd0) ? 1'b1 : 1'b0);

assign cond_fu_299_p2 = ((colorFormat == 8'd0) ? 1'b1 : 1'b0);

assign empty_fu_271_p1 = grp_reg_unsigned_short_s_fu_261_ap_return[12:0];
...
assign i_4_fu_313_p2 = (i_fu_102 + 12'd1);

assign icmp_ln789_fu_275_p2 = ((enableInput == 8'd0) ? 1'b1 : 1'b0);

assign icmp_ln800_fu_308_p2 = ((i_fu_102 == trunc_ln782_reg_369) ? 1'b1 : 1'b0);

assign srcYUV_din = grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_201_srcYUV_din;

assign trunc_ln782_fu_267_p1 = grp_reg_unsigned_short_s_fu_255_ap_return[11:0];
