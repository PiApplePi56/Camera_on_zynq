...
set C_modelArgList {
	...
	{ axi_data_out int 30 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_video_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_out", "interface" : "wire", "bitwidth" : 30, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ axi_data_out sc_out sc_lv 30 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_out", "direction": "out", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "axi_data_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	axi_data_out { ap_vld {  { axi_data_out out_data 1 30 }  { axi_data_out_ap_vld out_vld 1 1 } } }
