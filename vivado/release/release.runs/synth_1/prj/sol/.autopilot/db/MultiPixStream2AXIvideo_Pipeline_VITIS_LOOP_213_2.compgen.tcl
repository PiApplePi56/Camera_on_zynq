...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_video_TREADY { I 1 bit } m_axis_video_TDATA { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 75 \
    name width_load_cast1 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_width_load_cast1 \
    op interface \
    ports { width_load_cast1 { I 13 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgGamma_dout { I 30 vector } imgGamma_num_data_valid { I 5 vector } imgGamma_fifo_cap { I 5 vector } imgGamma_empty_n { I 1 bit } imgGamma_read { O 1 bit } } \
} "
}
