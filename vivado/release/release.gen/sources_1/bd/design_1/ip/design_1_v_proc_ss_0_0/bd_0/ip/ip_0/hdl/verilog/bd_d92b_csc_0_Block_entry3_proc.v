...
reg    ap_block_state1;
wire   [0:0] icmp_ln372_fu_172_p2;
wire   [0:0] icmp_ln373_fu_184_p2;
wire   [0:0] icmp_ln378_fu_196_p2;
wire   [0:0] or_ln378_fu_202_p2;
wire   [0:0] icmp_ln381_fu_214_p2;
wire   [0:0] or_ln381_fu_220_p2;
wire   [0:0] bPassThru_420_In_fu_178_p2;
wire   [0:0] bPassThru_420_Out_fu_190_p2;
wire   [0:0] bPassThru_422_or_420_In_fu_208_p2;
wire   [0:0] bPassThru_422_or_420_Out_fu_226_p2;
wire   [12:0] HwReg_width_1_fu_164_p1;
wire   [11:0] HwReg_height_1_fu_168_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_16_preg <= bPassThru_420_In_fu_178_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_17_preg <= bPassThru_420_Out_fu_190_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_18_preg <= bPassThru_422_or_420_In_fu_208_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_19_preg <= bPassThru_422_or_420_Out_fu_226_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_return_20_preg <= 13'd0;
    end else begin
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_20_preg <= HwReg_width_1_fu_164_p1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_21_preg <= HwReg_height_1_fu_168_p1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_16 = bPassThru_420_In_fu_178_p2;
    end else begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_17 = bPassThru_420_Out_fu_190_p2;
    end else begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_18 = bPassThru_422_or_420_In_fu_208_p2;
    end else begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_19 = bPassThru_422_or_420_Out_fu_226_p2;
    end else begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_20 = HwReg_width_1_fu_164_p1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_21 = HwReg_height_1_fu_168_p1;
    end else begin
...
assign HwReg_height_1_fu_168_p1 = height[11:0];

assign HwReg_width_1_fu_164_p1 = width[12:0];
...
assign bPassThru_420_In_fu_178_p2 = (icmp_ln372_fu_172_p2 ^ 1'd1);

assign bPassThru_420_Out_fu_190_p2 = (icmp_ln373_fu_184_p2 ^ 1'd1);

assign bPassThru_422_or_420_In_fu_208_p2 = (or_ln378_fu_202_p2 ^ 1'd1);

assign bPassThru_422_or_420_Out_fu_226_p2 = (or_ln381_fu_220_p2 ^ 1'd1);

assign icmp_ln372_fu_172_p2 = ((InVideoFormat == 8'd3) ? 1'b1 : 1'b0);

assign icmp_ln373_fu_184_p2 = ((OutVideoFormat == 8'd3) ? 1'b1 : 1'b0);

assign icmp_ln378_fu_196_p2 = ((InVideoFormat == 8'd2) ? 1'b1 : 1'b0);

assign icmp_ln381_fu_214_p2 = ((OutVideoFormat == 8'd2) ? 1'b1 : 1'b0);

assign or_ln378_fu_202_p2 = (icmp_ln378_fu_196_p2 | icmp_ln372_fu_172_p2);

assign or_ln381_fu_220_p2 = (icmp_ln381_fu_214_p2 | icmp_ln373_fu_184_p2);

endmodule //bd_d92b_csc_0_Block_entry3_proc
