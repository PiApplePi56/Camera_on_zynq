...
(* CORE_GENERATION_INFO="design_1_v_demosaic_0_0_v_demosaic,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=6.562000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.790260,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=70,HLS_SYN_DSP=0,HLS_SYN_FF=10534,HLS_SYN_LUT=9704,HLS_VERSION=2023_1}" *)
...
wire   [15:0] Block_entry1_proc_U0_ap_return;
...
wire   [1:0] AXIvideo2MultiBayer_U0_imgBayer_num_data_valid;
wire   [1:0] AXIvideo2MultiBayer_U0_imgBayer_fifo_cap;
...
wire   [1:0] bayer_phase_assign_channel_num_data_valid;
wire   [1:0] bayer_phase_assign_channel_fifo_cap;
...
wire   [1:0] imgRgb_fifo_cap;
wire    imgRgb_empty_n;
wire    imgUnzip_full_n;
wire   [23:0] imgUnzip_dout;
wire   [1:0] imgUnzip_num_data_valid;
wire   [1:0] imgUnzip_fifo_cap;
...
design_1_v_demosaic_0_0_Block_entry1_proc Block_entry1_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
design_1_v_demosaic_0_0_AXIvideo2MultiBayer AXIvideo2MultiBayer_U0(
    ...
    .imgBayer_num_data_valid(AXIvideo2MultiBayer_U0_imgBayer_num_data_valid),
    .imgBayer_fifo_cap(AXIvideo2MultiBayer_U0_imgBayer_fifo_cap),
...
design_1_v_demosaic_0_0_fifo_w8_d3_S imgBayer_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_demosaic_0_0_fifo_w24_d2_S_x imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_demosaic_0_0_fifo_w24_d2_S_x imgUnzip_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign AXIvideo2MultiBayer_U0_imgBayer_fifo_cap = imgBayer_fifo_cap;

assign AXIvideo2MultiBayer_U0_imgBayer_num_data_valid = imgBayer_num_data_valid;

assign Block_entry1_proc_U0_ap_continue = bayer_phase_assign_channel_full_n;
...
assign ap_idle = ((bayer_phase_assign_channel_empty_n ^ 1'b1) & ZipperRemoval_U0_ap_idle & MultiPixStream2AXIvideo_U0_ap_idle & Debayer_U0_ap_idle & Block_entry1_proc_U0_ap_idle & AXIvideo2MultiBayer_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_Block_entry1_proc_U0_ap_ready & ap_sync_AXIvideo2MultiBayer_U0_ap_ready);
