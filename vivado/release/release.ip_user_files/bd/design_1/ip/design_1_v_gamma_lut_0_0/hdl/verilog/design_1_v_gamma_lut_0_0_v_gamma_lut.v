...
(* CORE_GENERATION_INFO="design_1_v_gamma_lut_0_0_v_gamma_lut,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=6.562000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.381000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=1040,HLS_SYN_LUT=1486,HLS_VERSION=2023_1}" *)
...
design_1_v_gamma_lut_0_0_fifo_w24_d16_S imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_gamma_lut_0_0_fifo_w24_d16_S imgGamma_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
`include "design_1_v_gamma_lut_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "design_1_v_gamma_lut_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //design_1_v_gamma_lut_0_0_v_gamma_lut
