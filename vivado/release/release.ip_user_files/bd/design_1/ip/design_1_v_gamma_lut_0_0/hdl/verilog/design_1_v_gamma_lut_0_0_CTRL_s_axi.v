...
localparam
    ...
    ADDR_GAMMA_LUT_0_HIGH    = 13'h09ff,
    ADDR_GAMMA_LUT_1_BASE    = 13'h1000,
    ADDR_GAMMA_LUT_1_HIGH    = 13'h11ff,
    ADDR_GAMMA_LUT_2_BASE    = 13'h1800,
    ADDR_GAMMA_LUT_2_HIGH    = 13'h19ff,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [6:0]                    int_gamma_lut_0_address0;
    ...
    wire [6:0]                    int_gamma_lut_1_address0;
    wire                          int_gamma_lut_1_ce0;
    wire [31:0]                   int_gamma_lut_1_q0;
    wire [6:0]                    int_gamma_lut_1_address1;
    ...
    wire [6:0]                    int_gamma_lut_2_address0;
    wire                          int_gamma_lut_2_ce0;
    wire [31:0]                   int_gamma_lut_2_q0;
    wire [6:0]                    int_gamma_lut_2_address1;
...
assign int_gamma_lut_0_address1 = ar_hs? raddr[8:2] : waddr[8:2];
...
assign int_gamma_lut_1_address1 = ar_hs? raddr[8:2] : waddr[8:2];
...
assign int_gamma_lut_2_address1 = ar_hs? raddr[8:2] : waddr[8:2];
