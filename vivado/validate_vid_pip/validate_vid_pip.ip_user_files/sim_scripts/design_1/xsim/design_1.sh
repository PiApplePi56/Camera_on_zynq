...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L i2s_receiver_v1_0_6 -L i2s_transmitter_v1_0_6 -L axi_vip_v1_1_14 -L processing_system7_vip_v1_0_16 -L xilinx_vip"
