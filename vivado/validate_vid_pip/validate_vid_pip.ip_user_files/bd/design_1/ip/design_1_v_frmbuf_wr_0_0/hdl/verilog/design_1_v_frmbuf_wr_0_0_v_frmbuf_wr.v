...
(* CORE_GENERATION_INFO="design_1_v_frmbuf_wr_0_0_v_frmbuf_wr,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=6.562000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.790260,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=12,HLS_SYN_DSP=0,HLS_SYN_FF=4378,HLS_SYN_LUT=5759,HLS_VERSION=2023_1}" *)

module design_1_v_frmbuf_wr_0_0_v_frmbuf_wr (
        ap_clk,
        ap_rst_n,
...
wire   [11:0] empty_65_fu_191_p1;
reg   [11:0] empty_65_reg_232;
wire   [12:0] empty_66_fu_195_p1;
reg   [12:0] empty_66_reg_237;
wire  signed [14:0] trunc_ln150_fu_205_p1;
reg  signed [14:0] trunc_ln150_reg_247;
reg   [2:0] BYTES_PER_PIXEL_load_reg_257;
wire    ap_CS_fsm_state2;
reg   [2:0] colorFormat_reg_262;
wire   [14:0] mul_ln150_fu_212_p2;
reg   [14:0] mul_ln150_reg_267;
...
wire   [7:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WSTRB;
...
wire   [31:0] zext_ln150_fu_199_p1;
wire   [2:0] mul_ln150_fu_212_p0;
reg   [4:0] ap_NS_fsm;
...
wire   [14:0] mul_ln150_fu_212_p00;
wire    ap_ce_reg;
...
design_1_v_frmbuf_wr_0_0_BYTES_PER_PIXEL_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
design_1_v_frmbuf_wr_0_0_MEMORY2LIVE_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
design_1_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_160(
    ...
    .p_read(mul_ln150_reg_267),
    .p_read1(colorFormat_reg_262),
    .p_read2(empty_66_reg_237),
    .p_read3(empty_65_reg_232),
    .p_read14(stride_read_reg_222),
    .p_read25(empty_reg_227),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
design_1_v_frmbuf_wr_0_0_CTRL_s_axi #(
...
design_1_v_frmbuf_wr_0_0_mm_video_m_axi #(
    .CONSERVATIVE( 1 ),
    .USER_MAXREQS( 105 ),
...
design_1_v_frmbuf_wr_0_0_mul_3ns_15s_15_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 3 ),
    .din1_WIDTH( 15 ),
    .dout_WIDTH( 15 ))
mul_3ns_15s_15_1_1_U157(
    .din0(mul_ln150_fu_212_p0),
    .din1(trunc_ln150_reg_247),
    .dout(mul_ln150_fu_212_p2)
);

design_1_v_frmbuf_wr_0_0_regslice_both #(
    .DataWidth( 24 ))
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        empty_65_reg_232 <= empty_65_fu_191_p1;
        empty_66_reg_237 <= empty_66_fu_195_p1;
        empty_reg_227 <= empty_fu_187_p1;
        frm_buffer_read_reg_217 <= frm_buffer;
        stride_read_reg_222 <= stride;
        trunc_ln150_reg_247 <= trunc_ln150_fu_205_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        mul_ln150_reg_267 <= mul_ln150_fu_212_p2;
    end
end
...
assign BYTES_PER_PIXEL_address0 = zext_ln150_fu_199_p1;

assign MEMORY2LIVE_address0 = zext_ln150_fu_199_p1;
...
assign empty_65_fu_191_p1 = height[11:0];

assign empty_66_fu_195_p1 = width[12:0];
...
assign mul_ln150_fu_212_p0 = mul_ln150_fu_212_p00;

assign mul_ln150_fu_212_p00 = BYTES_PER_PIXEL_load_reg_257;

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign trunc_ln150_fu_205_p1 = width[14:0];

assign zext_ln150_fu_199_p1 = video_format;


reg find_df_deadlock = 0;
// synthesis translate_off
`include "design_1_v_frmbuf_wr_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "design_1_v_frmbuf_wr_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //design_1_v_frmbuf_wr_0_0_v_frmbuf_wr
