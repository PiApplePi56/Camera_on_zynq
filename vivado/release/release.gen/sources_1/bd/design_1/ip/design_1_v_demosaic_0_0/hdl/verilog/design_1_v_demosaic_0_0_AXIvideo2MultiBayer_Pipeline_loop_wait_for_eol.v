...
reg   [0:0] axi_last_4_reg_99;
reg   [0:0] eol_1_reg_110;
reg   [0:0] ap_phi_mux_axi_last_4_phi_fu_102_p4;
wire    ap_loop_init;
wire   [9:0] axi_data_fu_134_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start_int == 1'b0) | ((ap_phi_mux_eol_1_phi_fu_113_p4 == 1'd0) & (s_axis_video_TVALID == 1'b0))) & (ap_phi_mux_eol_1_phi_fu_113_p4 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        axi_last_4_reg_99 <= s_axis_video_TLAST;
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_phi_mux_axi_last_4_phi_fu_102_p4 = axi_last_2_lcssa;
    end else begin
        ap_phi_mux_axi_last_4_phi_fu_102_p4 = axi_last_4_reg_99;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        if ((ap_phi_mux_eol_1_phi_fu_113_p4 == 1'd0)) begin
            axi_data_4_out = axi_data_fu_134_p1;
...
assign axi_data_fu_134_p1 = s_axis_video_TDATA[9:0];

assign axi_last_4_out = ap_phi_mux_axi_last_4_phi_fu_102_p4;

endmodule //design_1_v_demosaic_0_0_AXIvideo2MultiBayer_Pipeline_loop_wait_for_eol
