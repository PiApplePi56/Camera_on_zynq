...
module bd_d92b_csc_0_hls_deadlock_idx0_monitor ( // for module bd_d92b_csc_0_v_csc_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[1] = idx1_block & (1'b0 | axis_block_sigs[0] | axis_block_sigs[2] | axis_block_sigs[1]);
...
// instant sub module
 bd_d92b_csc_0_hls_deadlock_idx1_monitor bd_d92b_csc_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
