...
(* CORE_GENERATION_INFO="design_1_v_tpg_0_0_v_tpg,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=6.562000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.790917,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=13,HLS_SYN_DSP=0,HLS_SYN_FF=7584,HLS_SYN_LUT=8104,HLS_VERSION=2023_1}" *)
...
reg   [0:0] icmp_ln455_reg_646;
wire    ap_CS_fsm_state2;
wire   [31:0] add_ln457_fu_589_p2;
reg   [31:0] add_ln457_reg_650;
wire   [23:0] grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TDATA;
wire   [2:0] grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TKEEP;
wire   [2:0] grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TSTRB;
...
wire   [15:0] grp_reg_unsigned_short_s_fu_573_ap_return;
reg    grp_reg_unsigned_short_s_fu_573_ap_ce;
reg   [31:0] count_new_0_reg_338;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln458_fu_595_p2;
reg    grp_v_tpgHlsDataFlow_fu_349_ap_start_reg;
wire    ap_CS_fsm_state4;
wire    ap_CS_fsm_state5;
wire    ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_ready;
wire    ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_done;
reg    ap_block_state5_on_subcall_done;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_ready;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done;
wire   [31:0] select_ln460_fu_626_p3;
wire   [28:0] tmp_1_fu_604_p4;
wire   [0:0] icmp_ln460_fu_614_p2;
wire   [31:0] add_ln462_fu_620_p2;
...
design_1_v_tpg_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_573(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .d(bck_motion_en),
    .ap_return(grp_reg_unsigned_short_s_fu_573_ap_return),
    .ap_ce(grp_reg_unsigned_short_s_fu_573_ap_ce)
);
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((icmp_ln458_fu_595_p2 == 1'd0)) begin
            count_new_0_reg_338 <= add_ln457_reg_650;
        end else if ((icmp_ln458_fu_595_p2 == 1'd1)) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln455_fu_579_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        add_ln457_reg_650 <= add_ln457_fu_589_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln455_reg_646 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        icmp_ln455_reg_646 <= icmp_ln455_fu_579_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln458_fu_595_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        s <= select_ln460_fu_626_p3;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1)))) begin
        grp_reg_unsigned_short_s_fu_573_ap_ce = 1'b1;
    end else begin
        grp_reg_unsigned_short_s_fu_573_ap_ce = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((icmp_ln455_fu_579_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign add_ln457_fu_589_p2 = (count + 32'd1);

assign add_ln462_fu_620_p2 = (s + 32'd1);
...
always @ (*) begin
    ap_block_state5_on_subcall_done = ((ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_ready & ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_done) == 1'b0);
end
...
assign ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_done = (grp_v_tpgHlsDataFlow_fu_349_ap_done | ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done);
...
assign icmp_ln455_fu_579_p2 = ((grp_reg_unsigned_short_s_fu_573_ap_return == 16'd1) ? 1'b1 : 1'b0);

assign icmp_ln458_fu_595_p2 = ((add_ln457_reg_650 == 32'd10) ? 1'b1 : 1'b0);

assign icmp_ln460_fu_614_p2 = (($signed(tmp_1_fu_604_p4) < $signed(29'd1)) ? 1'b1 : 1'b0);
...
assign select_ln460_fu_626_p3 = ((icmp_ln460_fu_614_p2[0:0] == 1'b1) ? add_ln462_fu_620_p2 : 32'd0);

assign tmp_1_fu_604_p4 = {{s[31:3]}};
