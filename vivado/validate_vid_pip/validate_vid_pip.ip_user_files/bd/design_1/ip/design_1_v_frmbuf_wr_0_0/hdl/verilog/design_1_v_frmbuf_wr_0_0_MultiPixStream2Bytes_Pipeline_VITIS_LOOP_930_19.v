...
module design_1_v_frmbuf_wr_0_0_MultiPixStream2Bytes_Pipeline_VITIS_LOOP_930_19 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] cmp499_fu_246_p2;
reg   [0:0] cmp499_reg_383;
...
wire   [13:0] x_2_cast_fu_242_p1;
wire  signed [13:0] sub498_cast13_cast_fu_218_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln930_fu_230_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        cmp499_reg_383 <= cmp499_fu_246_p2;
    end
end
...
assign cmp499_fu_246_p2 = (($signed(x_2_cast_fu_242_p1) < $signed(sub498_cast13_cast_fu_218_p1)) ? 1'b1 : 1'b0);

assign icmp_ln930_fu_230_p2 = ((ap_sig_allocacmp_x_1 == trunc_ln915_1) ? 1'b1 : 1'b0);

assign in_pix_fu_257_p1 = img_dout[7:0];

assign or_ln934_1_fu_269_p2 = (cmp501_2 | cmp499_reg_383);

assign or_ln934_2_fu_277_p2 = (cmp501_3 | cmp499_reg_383);

assign or_ln934_3_fu_285_p2 = (cmp501_4 | cmp499_reg_383);

assign or_ln934_4_fu_289_p2 = (cmp501_5 | cmp499_reg_383);

assign or_ln934_5_fu_293_p2 = (cmp501_6 | cmp499_reg_383);

assign or_ln934_6_fu_297_p2 = (icmp_ln920 | cmp499_reg_383);

assign or_ln934_fu_261_p2 = (cmp501_1 | cmp499_reg_383);

assign sub498_cast13_cast_fu_218_p1 = $signed(sub498_cast13);
...
assign x_2_cast_fu_242_p1 = ap_sig_allocacmp_x_1;

assign x_2_fu_236_p2 = (ap_sig_allocacmp_x_1 + 13'd1);

endmodule //design_1_v_frmbuf_wr_0_0_MultiPixStream2Bytes_Pipeline_VITIS_LOOP_930_19
